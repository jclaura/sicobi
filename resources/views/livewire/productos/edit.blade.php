<div wire:ignore.self class="modal fade" id="editProductoModal" tabindex="-1" role="dialog" aria-labelledby="editProductoModalLabel" aria-hidden="true">
            ...
            <div class="card-body">
              <div class="form-row">
                  <div class="col">
                    ...
                    <input type="text" wire:model="cod_prod" class="form-control" placeholder="Código">
                    @error('cod_prod') <span class="text-danger error">{{ $message }}</span>@enderror
                  </div>
                  <div class="col">
                    <label for="desc_prod">Descripción</label>
                    <input type="text" wire:model="desc_prod" class="form-control" placeholder="Descripción">
