{{-- VENTANA MODAL EDIT GRUPO--}}
<div wire:ignore.self class="modal fade" id="editGrupoModal" tabindex="-1" role="dialog" aria-labelledby="editGrupoModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editGrupoModalLabel">MODIFICAR REGISTRO</h5>
        ...
        <div class="modal-body">
          <form>            
            <div class="form-row">
                <div class="col">
                    <label for="SelectTiendaId">Depositos: </label>        
